  ...
  return <main className="shell">
    <aside className="sidebar">
      ...
      <div className="bottom">
        <div className="ai"><Sparkles/><div><strong>AI Estimator</strong><small>Ready for your next brief.</small></div></div>
        <div className="user"><i>D</i><div><strong>Developer</strong><small>Full Stack</small></div></div>
      </div>
    </aside>
    {renderPage()}
  </main>
